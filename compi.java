...
/*********************************************************************************************************************/
	...
	public String UL_reserve(String chaine) {
		...
		String[] Affichage = {"mot reserve pour guillemets",
				...
				"Mot reserve pour afficher un message ","mot reserve pour l'affichage de valeur de variable ", "carectere reserve pour un commentaire","carectere reserve", "Mot reserve Fin du programme" };
		int i = 0;
...
/*********************************************************************************************************************/
	...
	public String syntax(String chaine){
		...
		else if(chaine.startsWith("//.")) return "Commentaire";
		else if(chaine.equals("End_Program")) return "Fin du programme";
		else if(chaine.startsWith("ShowMes : \" " ) && chaine.endsWith(" \" ;;")) return "Chaine de carectere";
				...
				if(word[i].equals("Int_Number")){
					...
					if(word[i].equals(" "))
						...
						if(id(word[i]) != null){
							...
							if(word[i].equals(";;")) return "Declaration de "+k+" variables entieres";
						}
			...
			int i=0;
				...
				if(word[i].equals("Int_Number")){
					...
					if(num(word[i]) == "Nombre entier") {
							i++;
                                                        if(word[i].equals(" "))i++;
							if(word[i].equals(";;")) return "Affectation de la valeur entiere  "+word[i-1]+"  a la variable  "+word[i-3];
						}
						else if(num(word[i]) == "Nombre reel"){
							i++;
                                                        if(word[i].equals(" "))i++;
							if(word[i].equals(";;")) return "Affectation de la valeur reel : "+word[i-1]+" a la variable : "+word[i-3];
						}
					...
					if(word[i].equals(" "))i++;
                                        ...
                                        if(word[i].equals(" "))i++;
						if(id(word[i]) != null)i++;
							if(word[i].equals(";;")) return " Declaration d'une variable reel"+word[i-1];
						}
					...
					if(id(word[i]) != null){
						...
						if(id(word[i]) != null){
							i++;
						if(word[i].equals("--")) return "Condition Si ("+word[i-3]+word[i-2]+word[i-1]+") alors faire "; 
							}}}}
				}
					...
					if(word[i].equals("to")){
						...
						if(id(word[i]) != null) {
							i++;
							if(word[i].equals(";;")) return "Affectation de la variable "+word[i-3]+" a "+word[i-1];
						}
					...
					i++;
						...
						if(id(word[i]) != null)i++;
                                                if(word[i].equals("\""))i++;
                                                  if(word[i].equals(" "))i++;
							if(word[i].equals(";;")) return "Affichage du la chaine de carecteres : "+word[i-2];
						}
					...
					i++;
						...
						if(id(word[i]) != null)i++;
                                                  ...
                                                  if(word[i].equals(" "))i++;
							if(word[i].equals(";;")) return "Affichage du la valeur de "+word[i-1];
						}
	...
	private void initialize() {
		...
		frmMonAnalyseur.getContentPane().setBackground(new Color(178, 218, 210));
		...
		panel_1.setBackground(UIManager.getColor("menu"));
		panel_1.setBounds(331, 83, 598, 595);
		...
		textArea.setFont(new Font("Andale Mono", Font.PLAIN, 16));
						
										JButton btnNewButton = new JButton("Charger un Fichier");
										btnNewButton.setIcon(new ImageIcon("/Users/mac/Desktop/pic.png"));
										btnNewButton.setBounds(33, 163, 262, 61);
										...
										btnNewButton.setForeground(UIManager.getColor("inactiveCaptionBorder"));
										...
										btnNewButton.setFont(new Font("Roboto", Font.BOLD, 17));
														...
														btnAlexicale.setBounds(60, 256, 208, 80);
														...
														btnAlexicale.addActionListener(new ActionListener() {
															public void actionPerformed(ActionEvent e) {
																...
																int i = 0;
																while (i < words.size()) {
																	textArea.setText(textArea.getText()+words.get(i) + " ____ " + sortie_lexic.get(i)+"\n");
																	i++;}
															}
														});
														btnAlexicale.setForeground(UIManager.getColor("info"));
														...
														btnAlexicale.setFont(new Font("Roboto", Font.BOLD, 17));
																		...
																		btnAsyntaxique.setBounds(60, 356, 208, 80);
																		...
																		btnAsyntaxique.addActionListener(new ActionListener() {
																			public void actionPerformed(ActionEvent e) {
																				...
																				int i = 0;
																				while (i < lignes.size()) {
																					textArea.setText(textArea.getText()+lignes.get(i) + " ____ " +syntax(lignes.get(i))+"\n");
																					i++;}
																			}
																		});
																		...
																		btnAsyntaxique.setFont(new Font("Roboto", Font.BOLD, 17));
																						...
																						btnAsmantique.setBounds(60, 456, 208, 80);
																						...
																						btnAsmantique.addActionListener(new ActionListener() {
																							public void actionPerformed(ActionEvent e) {
																								...
																								while (i < lignes.size()) {
																									textArea.setText(textArea.getText()+lignes.get(i) + " ____ " +semantique(lignes.get(i))+"\n");
																						...
																						JTextArea txtrSorties = new JTextArea();
																						txtrSorties.setForeground(new Color(0, 0, 0));
																						txtrSorties.setFont(new Font("DialogInput", Font.BOLD, 20));
																						txtrSorties.setText("Sortie :");
																						txtrSorties.setBounds(331, 39, 81, 32);
																						frmMonAnalyseur.getContentPane().add(txtrSorties);
																						frmMonAnalyseur.getContentPane().setBackground(new Color(178, 218, 210));
		frmMonAnalyseur.setBounds(100, 100, 980, 718);
